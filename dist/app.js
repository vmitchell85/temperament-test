...
Vue.component('Question', __webpack_require__(33));
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        if (this.answer) {
            this.selection = this.question.attributes.find(function (a) {
                return a.value == _this.answer.value;
            });
        }
    },

    watch: {
        answer: function answer(to, from) {
            if (to) {
                this.selection = this.question.attributes.find(function (a) {
                    return a.value == to.value;
                });
            }
        }
    },
              ...
              return _c(
                ...
                [
                  _c("div", { staticClass: "pr-2" }, [
                    _vm.selection &&
                    answer &&
                    _vm.selection.value == answer.value
                      ? _c(
                          "svg",
                          {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1d8df916", module.exports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vuex_persistedstate__ = __webpack_require__(39);
...
var store = new __WEBPACK_IMPORTED_MODULE_1_vuex__["a" /* default */].Store({
    ...
    getters: {
        results: function results(state) {
            return {
                'Melancholy': state.answers.filter(function (a) {
                    return a.value == "M";
                }).length,
                'Sanguine': state.answers.filter(function (a) {
                    return a.value == "S";
                }).length,
                'Choleric': state.answers.filter(function (a) {
                    return a.value == "C";
                }).length,
                'Phlegmatic': state.answers.filter(function (a) {
                    return a.value == "P";
                }).length
            };
        },
    ...
    mutations: {
        ...
        saveAnswer: function saveAnswer(state, data) {
            var matchingEntry = state.answers.find(function (a) {
                return a.no == data.no;
            });
